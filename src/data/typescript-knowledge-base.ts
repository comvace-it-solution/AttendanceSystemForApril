...
export const knowledgeCategories: KnowledgeCategory[] = [
  ...
  },
  {
    ...
    order: 5,
    description: 'JS標準関数と勤怠システム独自関数の使いどころを覚える。',
    officialSourceUrls: [officialUrls.everydayTypes, officialUrls.functions],
  },
  {
    id: 'narrowing',
    title: 'Narrowing',
...
const terms: TermSeed[] = [
  ...
  { id: 'js-string-function', term: 'String()', categoryId: 'function-usage', definition: '値を文字列へ変換するJavaScript標準関数。', codeExample: 'String(user.id)', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'javascript', 'conversion'] },
  { id: 'js-number-function', term: 'Number()', categoryId: 'function-usage', definition: '値を数値へ変換するJavaScript標準関数。', codeExample: 'const numericUserId = Number(userId)', practical: ['学習ブランチ/AttendanceSystemForApril/src/composables/useDashboardData.ts'], tags: ['function-usage', 'javascript', 'conversion'] },
  { id: 'js-number-is-finite', term: 'Number.isFinite()', categoryId: 'function-usage', definition: '値が有限な数値かを判定するJavaScript標準メソッド。', codeExample: 'Number.isFinite(numericUserId)', practical: ['学習ブランチ/AttendanceSystemForApril/src/composables/useDashboardData.ts'], tags: ['function-usage', 'javascript', 'validation'] },
  { id: 'js-date-constructor', term: 'new Date()', categoryId: 'function-usage', definition: '日時文字列や現在時刻からDateオブジェクトを作る標準コンストラクタ。', codeExample: 'new Date(value)', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'date'] },
  { id: 'js-date-get-time', term: 'Date.prototype.getTime()', categoryId: 'function-usage', definition: 'Dateをミリ秒の数値へ変換するメソッド。', codeExample: 'new Date(end).getTime() - new Date(start).getTime()', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'date'] },
  { id: 'js-math-floor', term: 'Math.floor()', categoryId: 'function-usage', definition: '小数点以下を切り捨てるJavaScript標準関数。', codeExample: 'Math.floor(diffMs / 60000)', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'math'] },
  { id: 'js-math-max', term: 'Math.max()', categoryId: 'function-usage', definition: '複数の数値のうち最大値を返すJavaScript標準関数。', codeExample: 'Math.max(0, minutes)', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'math'] },
  { id: 'js-pad-start', term: 'String.prototype.padStart()', categoryId: 'function-usage', definition: '文字列の先頭を指定文字で埋めて長さを揃えるメソッド。', codeExample: "String(hours).padStart(2, '0')", practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'string'] },
  { id: 'js-array-map-method', term: 'Array.prototype.map()', categoryId: 'function-usage', definition: '配列の各要素を変換して新しい配列を作るメソッド。', codeExample: 'users.map((user) => ({ userId: String(user.id) }))', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'array'] },
  { id: 'js-array-find-method', term: 'Array.prototype.find()', categoryId: 'function-usage', definition: '条件に合う最初の要素を返す配列メソッド。', codeExample: 'users.find((user) => user.id === userId)', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'array'] },
  { id: 'js-array-reduce-method', term: 'Array.prototype.reduce()', categoryId: 'function-usage', definition: '配列の値を1つの結果へ集約するメソッド。', codeExample: 'breaks.reduce((total, row) => total + minutes, 0)', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'array'] },
  { id: 'js-array-some-method', term: 'Array.prototype.some()', categoryId: 'function-usage', definition: '条件に合う要素が1つでもあるかを判定する配列メソッド。', codeExample: 'breaks.some((row) => row.breakEndDt !== null)', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'array'] },
  { id: 'js-array-filter-method', term: 'Array.prototype.filter()', categoryId: 'function-usage', definition: '条件に合う要素だけを残して新しい配列を作るメソッド。', codeExample: 'items.filter(Boolean)', tags: ['function-usage', 'array'] },
  { id: 'js-array-sort-method', term: 'Array.prototype.sort()', categoryId: 'function-usage', definition: '配列を並べ替えるメソッド。元配列を変更する点に注意する。', codeExample: '[...records].sort((a, b) => b.id - a.id)', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], review: 'sortは破壊的なので、必要ならコピーしてから並べ替える。', tags: ['function-usage', 'array', 'mutation'] },
  { id: 'js-url-search-params', term: 'URLSearchParams()', categoryId: 'function-usage', definition: 'URLクエリ文字列を組み立てるための標準API。', codeExample: 'new URLSearchParams({ userId: String(userId) })', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'web-api'] },
  { id: 'js-json-stringify', term: 'JSON.stringify()', categoryId: 'function-usage', definition: 'JavaScriptの値をJSON文字列へ変換する標準関数。', codeExample: 'JSON.stringify(options.body)', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/apiClient.ts'], tags: ['function-usage', 'json'] },
  { id: 'js-response-json', term: 'Response.json()', categoryId: 'function-usage', definition: 'fetchのResponse本文をJSONとして読み取るメソッド。', codeExample: 'await response.json()', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/apiClient.ts'], tags: ['function-usage', 'fetch'] },
  { id: 'js-promise-all', term: 'Promise.all()', categoryId: 'function-usage', definition: '複数のPromiseを並行実行し、すべての完了を待つ関数。', codeExample: 'await Promise.all([buildAttendanceUsers(users), fetchAttendanceRecords(id)])', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'promise'] },
  { id: 'attendance-build-api-url', term: 'buildApiUrl()', categoryId: 'function-usage', definition: 'APIのbase URLとpathを結合してリクエストURLを作る勤怠システム独自関数。', codeExample: "buildApiUrl('/users')", practical: ['学習ブランチ/AttendanceSystemForApril/src/services/apiClient.ts'], tags: ['function-usage', 'attendance-custom'] },
  { id: 'attendance-has-data-property', term: 'hasDataProperty()', categoryId: 'function-usage', definition: 'APIレスポンスがdataプロパティを持つか判定する独自の型ガード関数。', codeExample: 'hasDataProperty(responseBody)', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/apiClient.ts'], tags: ['function-usage', 'attendance-custom', 'type-guard'] },
  { id: 'attendance-get-error-message', term: 'getErrorMessage()', categoryId: 'function-usage', definition: 'APIエラーレスポンスから表示用エラーメッセージを取り出す独自関数。', codeExample: 'getErrorMessage(responseBody, fallback)', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/apiClient.ts'], tags: ['function-usage', 'attendance-custom'] },
  { id: 'attendance-api-request', term: 'apiRequest()', categoryId: 'function-usage', definition: 'fetch、JSON変換、エラー処理、data取り出しをまとめた共通API関数。', codeExample: "apiRequest<UsersApiResponse>('/users')", practical: ['学習ブランチ/AttendanceSystemForApril/src/services/apiClient.ts'], tags: ['function-usage', 'attendance-custom', 'api'] },
  { id: 'attendance-get-target-month', term: 'getTargetMonth()', categoryId: 'function-usage', definition: '現在年月をAPI用のYYYY-MM形式で作る独自関数。', codeExample: 'getTargetMonth()', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'attendance-custom', 'date'] },
  { id: 'attendance-format-time', term: 'formatTime()', categoryId: 'function-usage', definition: '日時文字列を画面表示用のHH:mmへ変換する独自関数。', codeExample: 'formatTime(todayRecord?.workStartDt ?? null)', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'attendance-custom', 'date'] },
  { id: 'attendance-get-diff-minutes', term: 'getDiffMinutes()', categoryId: 'function-usage', definition: '開始日時と終了日時の差を分単位で計算する独自関数。', codeExample: 'getDiffMinutes(start, end)', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'attendance-custom', 'date'] },
  { id: 'attendance-format-minutes', term: 'formatMinutes()', categoryId: 'function-usage', definition: '分数をHH:mm形式の表示文字列へ変換する独自関数。', codeExample: 'formatMinutes(workedMinutes)', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'attendance-custom'] },
  { id: 'attendance-is-same-local-date', term: 'isSameLocalDate()', categoryId: 'function-usage', definition: '日時文字列が基準日と同じローカル日付か判定する独自関数。', codeExample: 'isSameLocalDate(record.workStartDt, new Date())', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'attendance-custom', 'date'] },
  { id: 'attendance-get-today-record', term: 'getTodayRecord()', categoryId: 'function-usage', definition: '勤怠記録配列から今日の勤務レコードを探す独自関数。', codeExample: 'getTodayRecord(records)', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'attendance-custom', 'array'] },
  { id: 'attendance-get-latest-record', term: 'getLatestRecord()', categoryId: 'function-usage', definition: '勤怠記録配列からIDが最大の最新レコードを取り出す独自関数。', codeExample: 'getLatestRecord(records)', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'attendance-custom', 'array'] },
  { id: 'attendance-to-status', term: 'toAttendanceStatus()', categoryId: 'function-usage', definition: 'APIの状態コードと退勤時刻から画面用の勤怠状態へ変換する独自関数。', codeExample: 'toAttendanceStatus(currentAttendanceState, latestWorkEndDt)', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'attendance-custom'] },
  { id: 'attendance-get-latest-break', term: 'getLatestBreak()', categoryId: 'function-usage', definition: '休憩配列から最新の休憩レコードを取り出す独自関数。', codeExample: 'getLatestBreak(todayRecord)', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'attendance-custom', 'array'] },
  { id: 'attendance-calculate-break-minutes', term: 'calculateBreakMinutes()', categoryId: 'function-usage', definition: '休憩レコードから合計休憩時間を分単位で計算する独自関数。', codeExample: 'calculateBreakMinutes(todayRecord?.breaks ?? [], currentAttendanceState)', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'attendance-custom', 'reduce'] },
  { id: 'attendance-calculate-worked-minutes', term: 'calculateWorkedMinutes()', categoryId: 'function-usage', definition: '勤務開始、終了、休憩時間から実働時間を分単位で計算する独自関数。', codeExample: 'calculateWorkedMinutes(todayRecord, currentAttendanceState)', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'attendance-custom'] },
  { id: 'attendance-fetch-users', term: 'fetchUsers()', categoryId: 'function-usage', definition: '従業員一覧APIを呼び、users配列を返す独自関数。', codeExample: 'const users = await fetchUsers()', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'attendance-custom', 'api'] },
  { id: 'attendance-fetch-records', term: 'fetchAttendanceRecords()', categoryId: 'function-usage', definition: '指定ユーザーと対象月の勤怠記録をAPIから取得する独自関数。', codeExample: 'fetchAttendanceRecords(user.id)', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'attendance-custom', 'api'] },
  { id: 'attendance-fetch-dashboard-data', term: 'fetchDashboardData()', categoryId: 'function-usage', definition: 'ダッシュボード表示に必要なサマリーと一覧をまとめて取得・整形する独自関数。', codeExample: 'fetchDashboardData(currentUserId.value)', practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'attendance-custom', 'api'] },
  { id: 'attendance-execute-punch-action', term: 'executePunchAction()', categoryId: 'function-usage', definition: '打刻操作に応じたAPIエンドポイントへPOSTする独自関数。', codeExample: "executePunchAction(userId, 'clockIn')", practical: ['学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts'], tags: ['function-usage', 'attendance-custom', 'api'] },
  { id: 'dashboard-load-dashboard', term: 'loadDashboard()', categoryId: 'function-usage', definition: '画面表示に必要な勤怠データを読み込み、Storeへ反映するComposable内関数。', codeExample: 'await loadDashboard()', practical: ['学習ブランチ/AttendanceSystemForApril/src/composables/useDashboardData.ts'], tags: ['function-usage', 'attendance-custom', 'composable'] },
  { id: 'dashboard-set-work-date', term: 'setWorkDate()', categoryId: 'function-usage', definition: '現在日付を画面表示用に整形してStoreへセットするComposable内関数。', codeExample: 'setWorkDate()', practical: ['学習ブランチ/AttendanceSystemForApril/src/composables/useDashboardData.ts'], tags: ['function-usage', 'attendance-custom', 'composable'] },
]
...
export const learningCards: LearningCard[] = glossaryTerms.map((term) => ({
  id: `card-${term.id}`,
...
const functionUsageQuizzes: QuizQuestion[] = [
  {
    id: 'function-string-user-id',
    cardId: 'card-js-string-function',
    chapterId: 'function-usage',
    type: 'code-reading',
    question: '`String(user.id)`を使う主な理由はどれですか？',
    codeSnippet: `return users.map((user) => ({
  userId: String(user.id),
  userName: user.userName,
}))`,
    sourceFile: '学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts',
    relatedTermIds: ['js-string-function'],
    choices: ['数値IDを画面用の文字列IDへ変換するため', 'ユーザー名を削除するため', '配列を並べ替えるため', 'APIキーを暗号化するため'],
    answer: '数値IDを画面用の文字列IDへ変換するため',
    explanation: '`String()`は値を文字列へ変換します。API内部ではnumber、画面側ではstringとして扱う境界で使われています。',
    difficulty: 'basic',
  },
  {
    id: 'function-number-current-user-id',
    cardId: 'card-js-number-function',
    chapterId: 'function-usage',
    type: 'code-reading',
    question: '`Number(userId)`を使う場面として正しいものはどれですか？',
    codeSnippet: `const userId = authStore.user?.userId
const numericUserId = Number(userId)`,
    sourceFile: '学習ブランチ/AttendanceSystemForApril/src/composables/useDashboardData.ts',
    relatedTermIds: ['js-number-function'],
    choices: ['文字列のユーザーIDを数値IDへ変換する', '日時をHH:mmへ変換する', '配列を合計する', 'JSONを文字列へ変換する'],
    answer: '文字列のユーザーIDを数値IDへ変換する',
    explanation: 'API関数がnumberのuserIdを要求するため、Store上の文字列IDを数値へ変換しています。',
    difficulty: 'basic',
  },
  {
    id: 'function-number-is-finite-check',
    cardId: 'card-js-number-is-finite',
    chapterId: 'function-usage',
    type: 'review',
    question: '`Number.isFinite(numericUserId)`で確認していることはどれですか？',
    codeSnippet: `return Number.isFinite(numericUserId) ? numericUserId : null`,
    sourceFile: '学習ブランチ/AttendanceSystemForApril/src/composables/useDashboardData.ts',
    relatedTermIds: ['js-number-is-finite'],
    choices: ['変換結果がAPIへ渡せる有限な数値か', '文字列が空白を含むか', '配列が空か', 'CSSが読み込まれたか'],
    answer: '変換結果がAPIへ渡せる有限な数値か',
    explanation: '数値化に失敗するとNaNになり得ます。有限な数値だけを通し、それ以外はnullにします。',
    difficulty: 'basic',
  },
  {
    id: 'function-map-transform-users',
    cardId: 'card-js-array-map-method',
    chapterId: 'function-usage',
    type: 'code-reading',
    question: '`map()`を覚えるときのキーワードはどれですか？',
    codeSnippet: `users.map((user) => ({
  userId: String(user.id),
  userName: user.userName,
}))`,
    sourceFile: '学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts',
    relatedTermIds: ['js-array-map-method'],
    choices: ['変換', '検索', '合計', '存在確認'],
    answer: '変換',
    explanation: '`map()`は各要素を別の形へ変換して、新しい配列を作ります。',
    difficulty: 'basic',
  },
  {
    id: 'function-find-effective-user',
    cardId: 'card-js-array-find-method',
    chapterId: 'function-usage',
    type: 'code-reading',
    question: '`find()`を覚えるときのキーワードはどれですか？',
    codeSnippet: `const effectiveUser = users.find((user) => user.id === userId)`,
    sourceFile: '学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts',
    relatedTermIds: ['js-array-find-method'],
    choices: ['最初に見つける', '全部変換する', '合計する', '必ず並べ替える'],
    answer: '最初に見つける',
    explanation: '`find()`は条件に合う最初の1件を返します。見つからない場合はundefinedです。',
    difficulty: 'basic',
  },
  {
    id: 'function-reduce-break-minutes',
    cardId: 'card-js-array-reduce-method',
    chapterId: 'function-usage',
    type: 'code-reading',
    question: '`reduce()`を覚えるときのキーワードはどれですか？',
    codeSnippet: `breaks.reduce((total, row) => {
  return total + getDiffMinutes(row.breakStartDt, row.breakEndDt)
}, 0)`,
    sourceFile: '学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts',
    relatedTermIds: ['js-array-reduce-method'],
    choices: ['集約', '1件検索', '存在確認', '文字列化'],
    answer: '集約',
    explanation: '`reduce()`は複数の値を1つの結果へまとめます。ここでは休憩時間を合計しています。',
    difficulty: 'basic',
  },
  {
    id: 'function-some-break-ended',
    cardId: 'card-js-array-some-method',
    chapterId: 'function-usage',
    type: 'code-reading',
    question: '`some()`を覚えるときのキーワードはどれですか？',
    codeSnippet: `(todayRecord?.breaks ?? []).some((row) => row.breakEndDt !== null)`,
    sourceFile: '学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts',
    relatedTermIds: ['js-array-some-method'],
    choices: ['1つでもあるか', 'すべて変換する', '全部合計する', '必ず削除する'],
    answer: '1つでもあるか',
    explanation: '`some()`は条件を満たす要素が1つでもあればtrueを返します。',
    difficulty: 'basic',
  },
  {
    id: 'function-sort-copy-first',
    cardId: 'card-js-array-sort-method',
    chapterId: 'function-usage',
    type: 'review',
    question: '`sort()`をレビューするとき特に注意することはどれですか？',
    codeSnippet: `return [...records].sort((a, b) => b.id - a.id)[0] ?? null`,
    sourceFile: '学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts',
    relatedTermIds: ['js-array-sort-method'],
    choices: ['sortは元配列を変更するため、必要ならコピーしてから使う', 'sortは必ずPromiseを返す', 'sortはDate専用である', 'sortはnullを生成する'],
    answer: 'sortは元配列を変更するため、必要ならコピーしてから使う',
    explanation: 'このコードは`[...records]`でコピーしてからsortしており、元配列を守っています。',
    difficulty: 'intermediate',
  },
  {
    id: 'function-json-stringify-body',
    cardId: 'card-js-json-stringify',
    chapterId: 'function-usage',
    type: 'code-reading',
    question: '`JSON.stringify(options.body)`の役割はどれですか？',
    codeSnippet: `body: options.body === undefined ? undefined : JSON.stringify(options.body)`,
    sourceFile: '学習ブランチ/AttendanceSystemForApril/src/services/apiClient.ts',
    relatedTermIds: ['js-json-stringify'],
    choices: ['送信bodyをJSON文字列へ変換する', 'レスポンスを数値にする', 'URLを結合する', '配列を検索する'],
    answer: '送信bodyをJSON文字列へ変換する',
    explanation: 'fetchでJSON APIへ送るため、JavaScriptの値をJSON文字列に変換しています。',
    difficulty: 'basic',
  },
  {
    id: 'function-response-json',
    cardId: 'card-js-response-json',
    chapterId: 'function-usage',
    type: 'code-reading',
    question: '`await response.json()`の役割はどれですか？',
    codeSnippet: `const responseBody = contentType.includes('application/json')
  ? await response.json()
  : null`,
    sourceFile: '学習ブランチ/AttendanceSystemForApril/src/services/apiClient.ts',
    relatedTermIds: ['js-response-json'],
    choices: ['HTTPレスポンス本文をJSONとして読み取る', 'HTTPメソッドをPOSTにする', '日時を分に変換する', '配列をコピーする'],
    answer: 'HTTPレスポンス本文をJSONとして読み取る',
    explanation: '`response.json()`は非同期で本文をJSONへ変換するため、`await`と一緒に使われます。',
    difficulty: 'basic',
  },
  {
    id: 'function-api-request-role',
    cardId: 'card-attendance-api-request',
    chapterId: 'function-usage',
    type: 'code-reading',
    question: '`apiRequest()`が共通化している処理はどれですか？',
    codeSnippet: `await apiRequest('/attendance/start', {
  method: 'POST',
  body: { userId },
})`,
    sourceFile: '学習ブランチ/AttendanceSystemForApril/src/services/apiClient.ts',
    relatedTermIds: ['attendance-api-request'],
    choices: ['API URL生成、headers、JSON化、エラー処理、data取り出し', '画面のCSSだけ', '画像の読み込みだけ', 'ルーティングだけ'],
    answer: 'API URL生成、headers、JSON化、エラー処理、data取り出し',
    explanation: 'API通信の共通処理を1か所へ集めることで、Service側はエンドポイントとbodyに集中できます。',
    difficulty: 'intermediate',
  },
  {
    id: 'function-format-time-role',
    cardId: 'card-attendance-format-time',
    chapterId: 'function-usage',
    type: 'code-reading',
    question: '`formatTime()`の戻り値として期待されるものはどれですか？',
    codeSnippet: `clockInTime: formatTime(todayRecord?.workStartDt ?? null)`,
    sourceFile: '学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts',
    relatedTermIds: ['attendance-format-time'],
    choices: ['画面表示用のHH:mm文字列またはnull', '従業員IDの配列', 'APIキー', 'CSSクラス名だけ'],
    answer: '画面表示用のHH:mm文字列またはnull',
    explanation: '日時があればHH:mm形式にし、未打刻ならnullを返します。',
    difficulty: 'basic',
  },
  {
    id: 'function-get-diff-minutes-role',
    cardId: 'card-attendance-get-diff-minutes',
    chapterId: 'function-usage',
    type: 'code-reading',
    question: '`getDiffMinutes()`が返す単位はどれですか？',
    codeSnippet: `const diffMs = new Date(end).getTime() - new Date(start).getTime()
return Math.max(0, Math.floor(diffMs / 60000))`,
    sourceFile: '学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts',
    relatedTermIds: ['attendance-get-diff-minutes'],
    choices: ['分', '秒', '時間文字列', 'ユーザー数'],
    answer: '分',
    explanation: 'ミリ秒差を60000で割って分に変換しています。',
    difficulty: 'basic',
  },
  {
    id: 'function-to-attendance-status-role',
    cardId: 'card-attendance-to-status',
    chapterId: 'function-usage',
    type: 'code-reading',
    question: '`toAttendanceStatus()`が変換しているものはどれですか？',
    codeSnippet: `return isSameLocalDate(latestWorkEndDt, new Date()) ? '退勤済み' : '出勤前'`,
    sourceFile: '学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts',
    relatedTermIds: ['attendance-to-status'],
    choices: ['API状態コードと日時から画面用の勤怠状態へ変換する', 'ユーザー名をメールへ変換する', 'CSSをJSへ変換する', '配列を必ず空にする'],
    answer: 'API状態コードと日時から画面用の勤怠状態へ変換する',
    explanation: 'API内部の状態と最新退勤日時を使い、画面に出す`出勤前`などの状態へ変換します。',
    difficulty: 'intermediate',
  },
  {
    id: 'function-calculate-break-minutes-role',
    cardId: 'card-attendance-calculate-break-minutes',
    chapterId: 'function-usage',
    type: 'code-reading',
    question: '`calculateBreakMinutes()`を覚えるときの説明として正しいものはどれですか？',
    codeSnippet: `const breakMinutes = calculateBreakMinutes(
  todayRecord?.breaks ?? [],
  currentAttendanceState,
)`,
    sourceFile: '学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts',
    relatedTermIds: ['attendance-calculate-break-minutes'],
    choices: ['休憩レコードから休憩時間の合計分を作る', '勤務一覧をAPIへPOSTする', '従業員名を検索する', 'URLを組み立てる'],
    answer: '休憩レコードから休憩時間の合計分を作る',
    explanation: '終了済み休憩や休憩中の経過時間を見て、合計休憩分数を算出します。',
    difficulty: 'intermediate',
  },
  {
    id: 'function-calculate-worked-minutes-role',
    cardId: 'card-attendance-calculate-worked-minutes',
    chapterId: 'function-usage',
    type: 'code-reading',
    question: '`calculateWorkedMinutes()`が考慮しているものはどれですか？',
    codeSnippet: `getDiffMinutes(record.workStartDt, endReference) -
  calculateBreakMinutes(record.breaks, currentAttendanceState)`,
    sourceFile: '学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts',
    relatedTermIds: ['attendance-calculate-worked-minutes'],
    choices: ['勤務時間から休憩時間を差し引くこと', 'ユーザーIDを文字列化すること', 'API URLを結合すること', 'CSSを読み込むこと'],
    answer: '勤務時間から休憩時間を差し引くこと',
    explanation: '実働時間は勤務開始から終了基準までの差分から休憩時間を引いて計算します。',
    difficulty: 'intermediate',
  },
  {
    id: 'function-fetch-dashboard-data-role',
    cardId: 'card-attendance-fetch-dashboard-data',
    chapterId: 'function-usage',
    type: 'code-reading',
    question: '`fetchDashboardData()`の責務として正しいものはどれですか？',
    codeSnippet: `const dashboardData = await fetchDashboardData(currentUserId.value)
dashboardStore.setSummary(dashboardData.summary)`,
    sourceFile: '学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts',
    relatedTermIds: ['attendance-fetch-dashboard-data'],
    choices: ['ダッシュボードに必要なデータ一式を取得・整形する', '画面のフォントサイズだけを決める', 'ログインフォームを描画する', 'DBファイルを削除する'],
    answer: 'ダッシュボードに必要なデータ一式を取得・整形する',
    explanation: 'Service層でAPI取得と整形を行い、ComposableやStoreへ扱いやすい`DashboardData`を渡します。',
    difficulty: 'intermediate',
  },
  {
    id: 'function-execute-punch-action-role',
    cardId: 'card-attendance-execute-punch-action',
    chapterId: 'function-usage',
    type: 'code-reading',
    question: '`executePunchAction()`が`PunchAction`を受け取る理由はどれですか？',
    codeSnippet: `export const executePunchAction = async (
  userId: number,
  action: PunchAction,
): Promise<void> => {
  await apiRequest<void>(endpointMap[action], { method: 'POST', body: { userId } })
}`,
    sourceFile: '学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts',
    relatedTermIds: ['attendance-execute-punch-action'],
    choices: ['打刻操作の種類に応じて呼ぶAPIを切り替えるため', 'ユーザー名を日付へ変換するため', '配列を合計するため', 'CSSを保存するため'],
    answer: '打刻操作の種類に応じて呼ぶAPIを切り替えるため',
    explanation: '`clockIn`などの操作名から`endpointMap`を引き、対応するAPIへPOSTします。',
    difficulty: 'intermediate',
  },
  {
    id: 'function-load-dashboard-role',
    cardId: 'card-dashboard-load-dashboard',
    chapterId: 'function-usage',
    type: 'code-reading',
    question: '`loadDashboard()`の役割として正しいものはどれですか？',
    codeSnippet: `const loadDashboard = async () => {
  ...
  try {
    ...
    sourceFile: '学習ブランチ/AttendanceSystemForApril/src/composables/useDashboardData.ts',
    relatedTermIds: ['dashboard-load-dashboard'],
    choices: ['画面表示に必要なデータ取得とStore更新をまとめる', 'APIのbase URLを作る', '休憩時間だけを計算する', '型定義ファイルを生成する'],
    answer: '画面表示に必要なデータ取得とStore更新をまとめる',
    explanation: 'Composable内の関数として、Serviceを呼び、Storeへ状態を反映し、Loadingも管理します。',
    difficulty: 'intermediate',
  },
  {
    id: 'function-get-target-month-role',
    cardId: 'card-attendance-get-target-month',
    chapterId: 'function-usage',
    type: 'code-reading',
    question: '`getTargetMonth()`が返す形式はどれですか？',
    codeSnippet: `return \`\${now.getFullYear()}-\${month}\``,
    sourceFile: '学習ブランチ/AttendanceSystemForApril/src/services/attendanceService.ts',
    relatedTermIds: ['attendance-get-target-month'],
    choices: ['YYYY-MM', 'HH:mm', 'userIdだけ', 'boolean'],
    answer: 'YYYY-MM',
    explanation: '勤怠記録取得APIの対象月として、現在年月を`YYYY-MM`形式で返します。',
    difficulty: 'basic',
  },
]

export const quizQuestions: QuizQuestion[] = [
  ...functionUsageQuizzes,
  ...sourceCodeQuizzes,
...
export const knowledgeBaseStats = {
  ...
  codeReadingQuizzes:
    codeReadingQuizzes.length +
    sourceCodeQuizzes.filter((quiz) => quiz.type === 'code-reading').length +
    functionUsageQuizzes.filter((quiz) => quiz.type === 'code-reading').length,
  sourceCodeQuizzes: sourceCodeQuizzes.length,
  functionUsageQuizzes: functionUsageQuizzes.length,
}
