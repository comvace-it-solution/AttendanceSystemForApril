  ...
  <div class="employee-list-page">
    <div class="employee-list-search-area">
      <el-input
        ...
        placeholder="例：従業員ID、氏名、生年月日、配属日"
        class="employee-list-search-input"
      />
    ...
    <div v-if="isFetchError" class="retry-area">
      <button class="retry-button" @click="fetchEmployees">再試行</button>
    </div>
      ...
      <div class="employee-list__content">
        ...
        <div class="employee-list__body">
          <div
            ...
            :key="employee.userId"
            class="employee-list__row"
          >
            <div>{{ employee.userId }}</div>

            <div
              class="employee-name"
              @click="handleNameClick(employee.userId)"
            >
              {{ employee.userName }}
            </div>
            ...
            <div>
              <el-button
                v-if="
                  employee.attendanceStatus === '退勤' ||
                  !employee.attendanceStatus
                "
                class="delete-button"
                @click="handleDeleteClick(employee.userId)"
              >
                削除
              </el-button>
            </div>
        ...
        >
          ...
          <div class="employee-card__actions">
            <el-button
              class="detail-button"
              @click="
                handleAttendanceDetailClick(employee.userId, employee.userName)
              "
            >
              勤怠詳細
            </el-button>
    ...
    />
    <SortBottomSheet
      v-model="sortBottomSheetVisible"
      :sort-key="sortKey"
...
const { employees, isFetchError, fetchEmployees } = useEmployeeList()
...
const handleConfirmDelete = async () => {
  const result = await deleteEmployee(
    Number(selectedDeleteUserId.value).toString(),
  )
